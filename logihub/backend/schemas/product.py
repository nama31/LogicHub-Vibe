...
class ProductBase(BaseModel):
    ...
    selling_price_som: int = Field(
        0, ge=0, validation_alias=AliasChoices("selling_price_som", "selling_price")
    )
...
class ProductUpdate(BaseModel):
    ...
    selling_price_som: int | None = Field(
        None, ge=0, validation_alias=AliasChoices("selling_price_som", "selling_price")
    )
