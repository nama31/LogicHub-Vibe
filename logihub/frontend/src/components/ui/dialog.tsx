...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 isolate z-50 bg-ocean/20 duration-100 supports-backdrop-filter:backdrop-blur-xs data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
        className
      )}
      {...props}
    />
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-6 -mb-6 flex flex-col-reverse gap-3 rounded-b-2xl border-t bg-secondary/20 p-6 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
